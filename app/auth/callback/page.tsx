...
function AuthCallbackContent() {
  ...
  const processAuth = useCallback(async () => {
    ...
    try {
      ...
      if (requireMfa === "true") {
        ...
        toast({
          title: "MFA Required",
          description: message || "Please complete two-factor authentication",
        });
      ...
      if (decodedToken.needsCompletion) {
        ...
        const params = new URLSearchParams({
          ...
          provider: "google",
          ...(decodedToken.profile?.firstName && {
            firstName: decodedToken.profile.firstName,
          }),
          ...(decodedToken.profile?.lastName && {
            lastName: decodedToken.profile.lastName,
          }),
          ...(decodedToken.profile?.picture && {
            picture: decodedToken.profile.picture,
          }),
  ...
  }, [searchParams, router, setAuthState, login, toast, isProcessing]);
