    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main
          ...
          style={{
            marginLeft:
              currentTheme.themeDirection === "rtl"
                ? 0
                : isSidebarCollapsed
                  ? "60px"
                  : "260px",
        ...
        >
          <div
            className={`
              bg-default-50 rounded-lg p-6 min-h-[calc(100vh-6rem)]
    ...
    <div className="min-h-screen bg-background bg-gray-50 ">
      ...
      <main
        ...
        ${currentTheme.themeDirection === "rtl" ? "dir-rtl" : ""}
          `}
      >
        <div className="rounded-lg min-h-[calc(100vh-8rem)] p-8 px-32 bg-gray-50 ">
          {children}
        </div>
      </main>
    </div>
