    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative">
        <input
          className={`
            w-full
            px-3 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3
            pr-12
        ...
        />
        <button
          className="absolute right-3 top-1/2 transform -translate-y-1/2 text-global-3 hover:text-global-1 transition-colors duration-200"
          disabled={disabled}
          type="button"
