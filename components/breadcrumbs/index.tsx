  ...
  if (custom && links && links.length > 0) {
    return (
      <div className="h-full flex items-center">
        <div
          className={`flex ${rightAlign ? "justify-between items-center" : "items-center"} gap-4`}
        >
          {title && !titleBottom && (
              ...
              return (
                <BreadcrumbItem key={index}>
                  {link.to ? (
                    ...
                    <span className="flex items-center text-default-900">
                      {Icon && <Icon className={iconClasses} />}
                      {link.title}
                    </span>
                  )}
            ...
            {main && main.type === "collapse" && (
              <BreadcrumbItem>
                ...
                >
                  <span className="flex items-center">
                    {icons && main.icon && (
                      <span className={iconClasses}>{main.icon}</span>
                    )}
                    {main.title}
                  </span>
                </NextLink>
